...
class macOS:
    ...
    def start(self) -> int:
        ...
        if result != 0:
            ...
            return 502
        command = "brew install jsoncpp sqlite3 sqlite-utils fmt clang-format curl googletest gcc zlib cmake libzip openssl wget boost asio libssh2 unzip zip libpq"
        result = os.system(command)
